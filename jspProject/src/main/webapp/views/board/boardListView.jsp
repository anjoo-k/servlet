...
<%
	...
	int currentPage = pi.getCurrnetPage();
    ...
    <div class="outer">
        ...
        <!-- 로그인한 사용자 일 때 -->
            <div align="right" style="width:850px; margin-bottom: 4px;">
                <a href="<%=contextPath %>/enrollForm.bo" class="btn-sm btn-secondary">글쓰기</a>
            </div>
        ...
        <script>
            ...
            for(let tr of trList){
                ...
                // this => 클릭한 객체를 말한다.
                // .childrent => 객체의 자식노드 list를 모두 가져온다. 즉 td 태그 안의 부분만 가져온다.
