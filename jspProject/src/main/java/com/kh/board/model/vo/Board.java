...
public class Board {
	...
	private String boardCategoryNo; // 작성기능 사용 시 => 카테고리 번호 | 조회 카테고리 등으로 쓰기 위해 String
	private String boardTitle;
	private String boardContent;
	private String boardWriter; // 작성기능 시 회원번호 | 조회기능 시 회원아이디
	private int count;
	...
	public Board(int boardNo, int boardType, String boardCategoryNo, String boardTitle, String boardContent,
	...
	public String toString() {
		return "Board [boardNo=" + boardNo + ", boardType=" + boardType + ", boardCategoryNo=" + boardCategoryNo
				+ ", boardTitle=" + boardTitle + ", boardContent=" + boardContent + ", boardWriter=" + boardWriter
				+ ", count=" + count + ", createDate=" + createDate + ", status=" + status + ", titleImg=" + titleImg
				+ "]";
	}
